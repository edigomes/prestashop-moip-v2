...
<p>Para configurar o seu módulo você deve selecionar um dos ambientes e após logar-se no moip você estará hapto a realizar suas transações.</p>
	<hr>
				...
				<table class="moip-table">
					...
					<thead>
					<tr>
						<th>Produção - Ambiente de compras reais <span><a href="https://conta.moip.com.br/">Moip Produção</a></span></th>
						<th>Sandbox - Ambiente destinado a testes <span><a href="https://conta-sandbox.moip.com.br/">Moip Sandbox</a></span></th>
					</tr>
					</thead>
					<tbody>
					<tr>
					...
					<tr>
						<td>
							...
							{else}
								<p>Você selecinou o ambiente de teste, para alterar a autorização do ambiente de produção é necessário alterar o ambiente.</p>
							{/if}
						</td>
						<td>
							{if $ambiente == "sandbox"}
								<div> <a href="{$url_process}" class="btn btn-primary" >Autorizar Moip em Produção</a></div>
							{else}
								<p>Você selecinou o ambiente de produção, para alterar a autorização do ambiente de teste é necessário alterar o ambiente.</p>
							{/if}
						</td>
					</tr>
