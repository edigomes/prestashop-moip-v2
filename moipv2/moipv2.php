...
class Moipv2 extends PaymentModule
{
	...
	public function __construct()
	{
		...
		$config = Configuration::getMultiple(array('MOIPV2_NAME','MOIPV2_CUPOMBOLETO','MOIPV2_BOLETODISCOUNT','MOIPV2_CARTAO_NUMBER','MOIPV2_KEY_TOKEN','MOIPV2_ENDPOINT','MOIPV2_OAUTH_PROD','MOIPV2_OAUTH_DEV','MOIPV2_PUBLICKEY_PROD','MOIPV2_PUBLICKEY_DEV', 'MOIPV2_STATUS_1','MOIPV2_STATUS_2','MOIPV2_STATUS_3','MOIPV2_STATUS_4','MOIPV2_STATUS_5','MOIPV2_BOLETO_ACEITE','MOIPV2_CARTAO_ACEITE','MOIPV2_TEF_ACEITE','MOIPV2_CARTAO_PARCEL2','MOIPV2_CARTAO_PARCEL3','MOIPV2_CARTAO_PARCEL4','MOIPV2_CARTAO_PARCEL5','MOIPV2_CARTAO_PARCEL6','MOIPV2_CARTAO_PARCEL7','MOIPV2_CARTAO_PARCEL8','MOIPV2_CARTAO_PARCEL9','MOIPV2_CARTAO_PARCEL10','MOIPV2_CARTAO_PARCEL11','MOIPV2_CARTAO_PARCEL12','MOIPV2_REDIR_BOLETO','MOIPV2_REDIR_TEF'));
		...
		if (isset($config['MOIPV2_STATUS_5']))
			$this->MOIPV2_STATUS_5 = $config['MOIPV2_STATUS_5'];
	...
	{	
		...
		$this->add_order_state('MOIPV2_STATUS_2','pt:Pagamento em Análise|br:Pagamento em Análise', 0, 1, '#fcffcf', 0, 1, 0, 'pt:moip_analise|br:moip_analise');
		return true;
	}
	...
	public function uninstall()
	{
		if (!Configuration::deleteByName('MOIPV2_NAME') 
                    ...
                    || !Configuration::deleteByName('MOIPV2_STATUS_5')
	...
	private function _postProcess()
	{
		if (Tools::isSubmit('btnSubmit'))
		{
			...
			Configuration::updateValue('MOIPV2_STATUS_5', Tools::getValue('MOIPV2_STATUS_5'));
			...
			Configuration::updateValue('MOIPV2_REDIR_BOLETO', Tools::getValue('MOIPV2_REDIR_BOLETO'));
			Configuration::updateValue('MOIPV2_REDIR_TEF', Tools::getValue('MOIPV2_REDIR_TEF'));
    ...
    public function getConfigFieldsValues()
	{
		...
		return array(
			...
			'MOIPV2_STATUS_5' =>  Tools::getValue('MOIPV2_STATUS_5', Configuration::get('MOIPV2_STATUS_5')),
			...
			'MOIPV2_REDIR_BOLETO' => Tools::getValue('MOIPV2_REDIR_BOLETO', Configuration::get('MOIPV2_REDIR_BOLETO')),
			'MOIPV2_REDIR_TEF' => Tools::getValue('MOIPV2_REDIR_TEF', Configuration::get('MOIPV2_REDIR_TEF')),
	...
	{	
		$redirectUri = Tools::getHttpHost(true).__PS_BASE_URI__.'modules/moipv2/Oauth.php?token='.Configuration::get('MOIPV2_KEY_TOKEN');
		...
		if(Configuration::get('MOIPV2_ENDPOINT') == 1){
			...
			$set_url_btn = $endpoint_moip.'?responseType='.$responseType.'&appId='.$appId.'&redirectUri='.$redirectUri.'&scope='.$scope;
	...
	public function hookPaymentReturn($params)
	{
		...
		if (in_array($state, array(Configuration::get('MOIPV2_STATUS_1'), Configuration::get('MOIPV2_STATUS_2'),Configuration::get('MOIPV2_STATUS_3'),Configuration::get('MOIPV2_STATUS_4'),Configuration::get('MOIPV2_STATUS_5'),Configuration::get('PS_OS_OUTOFSTOCK'), Configuration::get('PS_OS_OUTOFSTOCK_UNPAID'))))
		{
	...
	public function renderForm()
	{
		...
		$fields_form1 = array(
			'form' => array(
				'legend' => array(
					'title' => $this->l('Oauth Login (autorizar -> link)'),
		...
		$fields_form2 = array(
				...
				'input' => array(
					...
					array(
			            'type' => 'select',
			            'lang' => true,
			            'label' => $this->l('Status para pagamento realizado'),
					...
					array(
			            'type' => 'select',
			            'lang' => true,
			            'label' => $this->l('Aguardando Confirmação de pagamento'),
					...
					array(
			            'type' => 'select',
			            'lang' => true,
			            'label' => $this->l('Pagamento em analise'),
					...
					array(
			            'type' => 'select',
			            'lang' => true,
			            'label' => $this->l('Pagamento reembolsado'),
	...
	$options_true3 = array(
		...
		$fields_form4 = array(
				'form' => array(
				'legend' => array(
					'title' => $this->l('Configuração para pagamento de Boleto e Transferência'),
					'icon' => 'icon-AdminParentOrders'
				),
				'input' => array(
					...
					array(
			            'type' => 'select',
			            'lang' => true,
			            'label' => $this->l('Redirecionar Automáticamente a Confirmação da Order, para o boleto?'),
			            'name' => 'MOIPV2_REDIR_BOLETO',
					...
					array(
			            'type' => 'select',
			            'lang' => true,
			            'label' => $this->l('Redirecionar Automáticamente a Confirmação da Order, para a Transferência?'),
			            'name' => 'MOIPV2_REDIR_TEF',
